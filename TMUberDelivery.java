...
public class TMUberDelivery extends TMUberService {
    ...
    public TMUberDelivery(String from, String to, User user, int distance, double cost, String type,
    ...
    public boolean equals(Object other) {
        ...
        TMUberDelivery del = (TMUberDelivery) other;
        return super.equals(del) && restaurant.equals(del.restaurant) && foodOrderId.equals(del.foodOrderId);
